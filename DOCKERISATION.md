...
```bash
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.6 -entry analysis --fastq_dir='fastq_pass' \
...
```bash
docker pull ghcr.io/edinburgh-genome-foundry/sequeduct:v0.4.6
```
