...
![version](https://img.shields.io/badge/current_version-0.4.6-blue)
...
```bash
nextflow pull edinburgh-genome-foundry/Sequeduct -r v0.4.6
```
...
```bash
# Demultiplex
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.6 -entry demultiplex \
    --fastq_dir='fastq_pass' \
    --reference_dir='genbank' \
    --sample_sheet='sample_sheet.csv'
# Preview
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.6 -entry preview \
    --fastq_dir='fastq_pass' \
    --reference_dir='genbank' \
    --sample_sheet='sample_sheet.csv'
# Analysis
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.6 -entry analysis \
    --fastq_dir='fastq_pass' \
    --reference_dir='genbank' \
    --sample_sheet='sample_sheet.csv' \
    --projectname='EGF project'
# Review
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.6 -entry review \
    --reference_dir='genbank' \
...
# De novo assembly
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.6 -entry assembly \
    --fastq_dir='fastq_pass' \
