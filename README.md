...
![version](https://img.shields.io/badge/current_version-0.4.0-blue)
...
```bash
nextflow pull edinburgh-genome-foundry/Sequeduct -r v0.4.0
```
...
```bash
docker pull ghcr.io/edinburgh-genome-foundry/sequeduct:v0.4.0
```
...
```bash
# Preview
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.0 -entry preview --fastq_dir='fastq_pass' \
    --reference_dir='genbank' \
    --sample_sheet='sample_sheet.csv' \
    -with-docker sequeduct_local
# Analysis
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.0 -entry analysis --fastq_dir='fastq_pass' \
    --reference_dir='genbank' \
    --sample_sheet='sample_sheet.csv' \
    --projectname='EGF project' \
    -with-docker sequeduct_local
# Review
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.0 -entry review --reference_dir='genbank' \
    ...
    -with-docker sequeduct_local
# De novo assembly
nextflow run edinburgh-genome-foundry/Sequeduct -r v0.4.0 -entry assembly --fastq_dir='fastq_pass' \
